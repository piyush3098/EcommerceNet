...
namespace ECommerce
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<iUserController, UserService>();
            // services.AddScoped<iAddressController, AddressService>();
             services.AddScoped<iProductController, productService>();
             services.AddScoped<iComents, CommentsService>();
